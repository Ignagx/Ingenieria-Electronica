...
\begin{enumerate}[label=\alph*)]
  ...
  \begin {itemize}
    ...
    La densidad espectral tambien es una señal de tiempo continuo, y no acepta simetria par.\\
    ...
    $$
    \begin{aligned}
    \int \Bigg[\phantom{/}\frac{2}{\omega} \sin\left(\frac{\omega T}{2}\right)\Bigg]^2 d\omega
    &=\int \frac{4}{\omega^2} \sin^2\left(\frac{\omega T}{2}\right) d\omega \\
    &= \sin^2\left(\frac{\omega T}{2}\right) \Big(-\frac{4}{\omega}\Big) - \int \Big(-\frac{4}{\omega}\Big)
      \frac{T}{2} \sin(\omega T)d\omega \\
    &= \sin^2\Big(\frac{\omega T}{2}\Big)\Big(-\frac{4}{\omega}\Big) +
      2 T^2 \int \frac{\sin(\omega T)}{\omega T}d\omega \\
    \end{aligned}
    $$
    Apoyandonos en la siguiente sustitución:
    $$
    \begin{aligned}
    \omega T &= x \\
    Td\omega &= dx \\
    ...
    $$
    \begin{aligned}
    &= -\sin^2\Big(\frac{\omega T}{2}\Big)\frac{4}{\omega} + 2T \int \frac{\sin(x)}{x} dx\\
    &=\Big[-\frac{4}{\omega} \Big(\frac{1- \cos(wt)}{2}\Big) + 2T Si(x)\Big]\Big|_{-\infty}^{\infty}\\
    &=\Big[\frac{2}{\omega} (\cos(wt) - 1) + 2T Si(x)\Big]\Big|_{-\infty}^{\infty}\\
    \end{aligned}
    $$
    Desarrollando el primer termino:\\
    $$
    \begin{aligned}
    &= 2\frac{\cos(\omega T)-1}{\omega} \Big|_{-\infty}^{\infty} \\
    &= 2\frac{\cos(\omega T)-1}{\omega} \Big|_{-\infty}^{0} + 2\frac{\cos(\omega T)-1}{\omega} \Big|_{0}^{\infty}\\
    &=2 \lim_{\omega \to 0} \frac{\cos(\omega T)-1}{\omega} - 2\lim_{\omega \to -\infty} 
    \frac{\cos(\omega T)-1}{\omega} + 2\lim_{\omega \to \infty}
    \frac{\cos(\omega T)-1}{\omega} - 2 \lim_{\omega \to 0} \frac{\cos(\omega T)-1}{\omega} \\
    &= 2T \lim_{x \to 0} \frac{\cos(x)-1}{x} - 2T \lim_{x \to 0} \frac{\cos(x)-1}{x} = 0
    \end{aligned}
    $$
    ...
    2T(\lim_{\omega \to \infty} \text{Si}(\omega T) - \text{Si}(0))\\
