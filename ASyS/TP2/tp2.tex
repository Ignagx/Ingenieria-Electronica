...
\begin{enumerate}[label=\alph*),left=0pt]
  \item Calcular el periodo fundamental $T_0$ de las señales $x_1, x_2$. ¿Las señales tienen energía finita? Calcular
    ...
    \begin{aligned}
      ...
      \Longrightarrow E &= \int_{0}^{\pi} \frac{1 - \cos(2t)}{2} \, dt \\
                        &= \frac{1}{2} \int_{0}^{\pi} (1 - \cos(2t)) \, dt \\
                        &= \frac{1}{2} \left( \int_{0}^{\pi} dt - \int_{0}^{\pi} \cos(2t) \, dt \right)
    \end{aligned}
    $$
    
    \textbf{Resolviendo la integral por sustitución}
    ...
    $$
    \begin{aligned}
      \therefore E &= \frac{1}{2} \left( \pi - \frac{1}{2} \int_{0}^{2\pi} \cos(u) \, du \right) \\
