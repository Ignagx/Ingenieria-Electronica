...
\chapter{}%ejercicio 4
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item Usando la descripción explicita de la salida del Sistema $y_t = S_1\{x_t\}$ (CI arbitrarias), demostrar si el
      ...
      los cuales se demuestran a continuacion, donde $x_a$ y $x_b$ son dos señales arbitrarias, e $y_5 = S_1\{x_a\},
      y_6 = S_1\{x_b\}$ y $y_7 = S_1\{x_a + x_b\}$:
      \begin{align*}
        y_5(t) &= x_a \cdot \frac{1}{R} + \left(y_0 - \frac{x_0}{R}\right) \cdot
          e^{\frac{-t}{RC}} - \frac{1}{R^2C} \int_{0}^{t} x_a \cdot e^{\frac{-(t-\tau)}{RC}} d\tau\\[6pt]
        y_6(t) &= x_b \cdot \frac{1}{R} + \left(y_0 - \frac{x_0}{R}\right) \cdot
          e^{\frac{-t}{RC}} - \frac{1}{R^2C} \int_{0}^{t} x_b \cdot e^{\frac{-(t-\tau)}{RC}} d\tau\\[6pt]
        y_7(t) &= (x_a - x_b) \cdot \frac{1}{R} + \left(y_0 - \frac{x_0}{R}\right) \cdot
          e^{\frac{-t}{RC}} - \frac{1}{R^2C} \int_{0}^{t} (x_a - x_b) \cdot e^{\frac{-(t-\tau)}{RC}} d\tau\\[6pt]
      \end{align*}
  ...
  caracteristica: $v(t) = Ri_{(t)} + L \frac{d}{dt} i_{(t)} + \frac{1}{C} \int_{0}^{t} i_{(\tau)} d\tau$
