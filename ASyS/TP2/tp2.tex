...
$$
   \begin{aligned}{l}
  $$ u&=2t, du&=2dt ⟹ dt&=\frac{du|2} &&
  \end{aligned}
$$
$$
   \begin{aligned}{l}
  \therefore \ &=\frac{1}{2} *\left(\int _{0}^{\pi } dt\ -\int _{0}^{\pi }\frac{\cos( u)}{2} du\right)\\
  &=\frac{1}{2} *\left(( \pi -0) -\frac{1}{2}\int _{0}^{\pi }\cos( u) du\right) \ \ \\
  &=\frac{\pi }{2} -\left(\frac{1}{4} *\int _{0}^{\pi }\cos( u) du\right)\\
  &=\frac{\pi }{2} -\left(\frac{1}{4} *(\sin( 2\pi ) -\sin( 2*0))\right)\\
  &=\frac{\pi }{2} -\left(\frac{1}{4} *( 0-0)\right)\\
  &=\frac{\pi }{2}
  \end{aligned}
&&
