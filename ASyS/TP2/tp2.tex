...
%      independientemente de lo que valga, el aporte a la integracion va a ser nulo. Esto permite 
  ...
  \item Sea $y_t = S\{x_t\}$ el sistema obtenido de las soluciones al sistema de Ecuaciones Diferenciales del inciso
    ...
    \end{gather*}
>>>>>>> 0abba40 (Pasa casi todo el ej4.B)
...
\item Restringir el sistema anterior a CI nulas y obtener la formula de la respuesta transformada $Y_{(s)} = \mathcal{L}\{y\}$.
  ...
  \item Trabajar con el sistema linealizado del inciso anterior, y calcular la transformada
    ...
    \begin{align*}
      ...
      y_1(t) &= \frac{1}{2\pi j} \frac{3}{L} \oint_C \frac{se^{s(t-2)}}{s^2 + \frac{R}{L} s + \frac{1}{LC}} ds\\[6pt]
    ...
    \begin{align*}
      ...
      y_2(t) &= \frac{1}{2\pi j} \frac{1}{L} \oint_C \frac{se^{s(t+2)}}{s^3 + \frac{R}{L} s^2 + \frac{1}{LC}s} ds\\[6pt]
