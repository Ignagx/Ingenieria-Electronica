...
Se procede partiendo desde la definición de mapeo para una razón cruzada:
...
\begin{align*}
    \frac{z_1 \left(\frac{z}{z_1}-1\right) }{z-z_3} \frac{z_2-z_3}{z_1 \left( \frac{z_2}{z_1} -1 \right) } &= \frac{w-w_1}{w_3 \left( \frac{w}{w_3} - 1 \right)} \frac{w_3 \left( \frac{w_2}{w_3} -1 \right) }{w_2-w_1}\\[10pt]
    \frac{\frac{z}{z_1} -1}{z-z_3} \frac{z_2-z_3}{\frac{z_2}{z_1}-1} &= \frac{w-w_1}{\frac{w}{w_3}-1} \frac{\frac{w_2}{w_3}-1}{w_2-w_1}
\end{align*}
...
Para simplificar el desarrollo del ejercicio, se realizarán dos mapeos. Uno, \( w_0 \), que va a ser el mapeo recíproco, y otro, \( w_1 \), que va a ser la traslación del mapeo \( w_0 \) a \( -j \).\\
...
Para simplificar el desarrollo del ejercicio, como se hizo antes, se realizarán dos mapeos. Uno, \( w_0 \), que va a ser el mapeo recíproco, y otro, \( w_1 \), que va a ser la traslación del mapeo \( w_0 \) a \( -j \).
...
\begin{itemize}
    \item $R_1 = x + j\frac{\pi}{4}$, $2 \leq x \leq 5$
    \item $R_2 = 5 + jy$, $\frac{\pi}{4} \leq y \leq \frac{\pi}{2}$
    \item $R_3 = x + j\frac{\pi}{2}$, $2 \leq x \leq 5$
    \item $R_4 = 2 + jy$,  $\frac{\pi}{4} \leq y \leq \frac{\pi}{2}$
\end{itemize}
...
\begin{itemize}
    ...
    \item $R_2 = e^{3 \cdot 5+j3y} + 2$, $\frac{\pi}{4} \leq y \leq \frac{\pi}{2}$
    \item $R_3 = e^{3x+j\frac{3\pi}{2}} + 2$, $2 \leq x \leq 5$
    \item $R_4 = e^{3 \cdot 5+j3y} + 2$, $\frac{\pi}{4} \leq y \leq \frac{\pi}{2}$
\end{itemize}
...
Como la funcion es un cociente de polinomios complejos va a tener singularidades cuando el denominador sea cero:
