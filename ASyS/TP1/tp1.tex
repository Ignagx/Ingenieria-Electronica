...
\vspace{33em} % Agregar espacio vertical


\textbf{c) Obtener las fórmulas y graficar \( C' \) en el plano \( W \), sabiendo que \( C = \{z \in \mathbb{C} \mid |z - 1 - j| = 2\} \) en el plano \( W \).}
...
\begin{figure}[t] % Aquí comienza el ambiente de figura
    \centering % Centrar la imagen
