...
\textbf{Clasificación de polos:}\\
Para $z_1$:
$$\lim_{z \to 0}\frac{6\cancel{z^2}}{(1- 2j)z^{2} + 6jz - (1 + 2j)} \cdot \frac{dz}{\cancel{z^2}}
=\frac{6}{- (1 + 2j)}=-\frac{6}{5}+\frac{12}{5}j$$ 
\begin{center}Singularidad evitable\end{center}

Para $z_2$:
$$\lim_{z \to \frac{2}{5}-\frac{1}{5}j}\frac{6z^2}{(1- 2j)z^{2} + 6jz - (1 + 2j)} \cdot \frac{dz}{z^2}
=$$
\begin{center}Polo simple\end{center}
