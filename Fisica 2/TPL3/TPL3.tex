...
\ctikzset{bipoles/vsourceam/inner minus={\tiny $-$}}
    \draw (0,0) to[voltmeter, l_ =$V1$, ](0,3) -- (4,3)
    to[R, l=$6\Omega$](6,3) -- (9,3)
    to(9,3) -- (9,4);
    \draw (3,3) -- (3,5)
    to(3,5) -- (4,5)
    to[R, l=$3\Omega$] (6,5) -- (7,5)
    to[ammeter, l =$A_1 \, 2A$] (8,5) -- (9,5)
    to (9,5) -- (9,4);
    \draw (9,4) to[R, l=$5\Omega$](11,4) -- (12,4)
    to [battery1 ,l =$\epsilon$, invert] (14,4) -- (14,1)
    to [R ,l =$2\Omega$](14,-1) -- (14,-3)
    to [ammeter, l=$A_2$](13,-3) -- (12,-3)
    to [R , l =$1\Omega$](10,-3) -- (9, -3)
    to [battery1, l=$28V$](7, -3) -- (6, -3)
    to [R , l =$2\Omega$](4,-3) -- (0, -3)
    to (0,0);
    \draw (3,-3) -- (3,-2)
    to [R ,l =$R_1 \, 3\Omega$](3,-1) -- (3,1)
    to [battery1, l =$50V$, invert] (3,2) -- (3,3);
\end{circuitikz}
\end{document}
