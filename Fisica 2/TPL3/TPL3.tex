...
\begin{circuitikz}
    \draw (0,0) to[battery1, l =$\epsilon_1$, invert](0,3) -- (1,3)
    to[R , l=$R1$](2,3)
    ...
    to (8,2) -- (8,3);
    \draw (13,3) -- (14,3)
    to [battery1, l =$\epsilon_2$] (14,-1.5) -- (14,-2)
    to (14,-2) -- (13,-2);
    \draw (13,-2) -- (13, -3)
    to[R , l=$R5$] (9.5,-3) -- (9,-3)
    to (9,-3) -- (9,-1) 
...
\begin{aligned}
    ...
    &R7=2\Omega\\[6pt]
    &\epsilon_1=50V &&\epsilon_2=30V&&\epsilon_3=20V\\[6pt]
    &V_1=\,? &&V_2=\,? &&A_1=\,?\\[6pt]
    &A_2=\,?\\[6pt]
\end{aligned}
$$
